...
impl NewCustomer {
    pub fn new(visible_customer_id: i32, salutation: crate::models::Salutation, company_name: String, given_name: String, family_name: String, delivery_instructions: String, address: String, address_extra: String, zip: String, town: String, country: String, grace_period: i32, used_bank_accounts: Vec<String>) -> NewCustomer {
        NewCustomer {
            visible_customer_id,
            salutation,
            company_name,
